...
public class AddStudent extends JFrame implements ActionListener
{
    ...
    AddStudent()
    {
         ...
         lblphone.setBounds(450,250,100,30);
         ...
         tfxii.setBounds(180,350,150,30);
         add(tfxii);
         
         JLabel lbladhar = new JLabel("Adhar Number :");
         lbladhar .setBounds(450,350,150,30);
         ...
         String course[]={"BBA","BCA","Bsc","Msc","MBA","MCA","MA","BA"};
         cbcourse=new JComboBox(course);
         cbcourse.setBounds(180,400,150,30);
    ...
    public void actionPerformed(ActionEvent ae)
    {
       if(ae.getSource() ==submit)
       {
           ...
           try
           {
              String query = "insert into student values('"+name+"', '"+fname+"','"+rollno+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+x+"','"+xii+"','"+adhar+"','"+course+"')";
